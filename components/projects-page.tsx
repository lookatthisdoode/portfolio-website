...
export default function ProjectsPage() {
  return (
    ...
    >
      ...
      >
        <h1
          className={`md:text-7xl text-backgroundDark text-3xl py-2 ${palanquin.className} hidden md:block`}
        >
          Projects
        </h1>
        <h2
          className={`${robotoMono.className} text-sm text-gray-600 md:pl-3 md:text-2xl hidden md:block`}
        >
